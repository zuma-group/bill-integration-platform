...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (process.env.ODOO_WEBHOOK_URL) {
      try {
        console.log('\n=ƒÜÇ ATTEMPTING TO SEND TO ODOO...');
        ...
        console.log('\n=ƒôí Response received from Odoo:');
        ...
        if (!odooResponse.ok) {
          ...
          console.error('G¥î ODOO WEBHOOK FAILED');
          ...
          console.log('G£à ODOO WEBHOOK SUCCESS');
        ...
        console.error('\n=ƒöÑ CRITICAL ERROR sending to Odoo webhook:');
      ...
      console.warn('\nGÜán+Å ODOO_WEBHOOK_URL is not configured');
